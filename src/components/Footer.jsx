        ...
        <div  style={{height:'300px', color:'white'}}className='d-flex justify-content-center align-items-center w-100 flex-column bg-primary'>
            <div className='d-flex justify-content-evenly align-items-center w-100'>
                <div className="websites" style={{width:'400px'}}>
                    ...
                    <i class="fa-solid fa-cart-shopping me-3"> E-CART</i> 
                  
                    </h4>
                    <h6>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Beatae fugit nihil reiciendis blanditiis praesentium cumque labore repudiandae?
                         Ut consectetur odit cumque nobis,
                         corrupti nostrum ad minima et, necessitatibus doloremque error!</h6>
                </div>
                ...
                <div className="contact d-flex flex-column">
                    ...
                    <div className='d-flex mb-2'>
                        ...
                        <button className='btn btn-warning ms-2 align-items-center justify-content-center d-flex p-2'>Subscribe</button>
                    </div>
                    ...
                    <Link to={'/watch-history'}style={{textDecoration:'none' ,color:'white'}}><i class="fa-brands fa-twitter fa-2x"></i></Link>
